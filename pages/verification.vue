      ...
      <n-spin :show="loading">
        ...
        <n-card title="认证总览">
          ...
          <n-space vertical>
            <n-el>
              一级认证:
              <n-tag type="warning" v-if="!data.realPerson">未通过</n-tag>
              <n-tag type="success" v-if="data.realPerson">已通过</n-tag>
            </n-el>
          </n-space>
          <n-el>
            二级认证:
            <n-tag type="warning" v-if="!data.realName">未通过</n-tag>
            <n-tag type="success" v-if="data.realName">已通过</n-tag>
          </n-el>
        </n-card>
        <br />
              ...
              <n-tabs type="line" default-value="buy" animated>
                ...
                <n-tab-pane name="recieve" tab="赠送">
                  ...
                  >
                    ...
                    >
                      <n-input
                        v-model:value="verificationForm.giftAccreditationUserId"
                        placeholder="目标用户 ID"
                      />
                    </n-form-item>
                    <n-button
              ...
              <n-card title="提交认证" size="small">
                <n-space vertical>
                  ...
                  >
                    ...
                    <n-space>
                      <n-button type="success" @click="handleRealPersonQrCode()"
                        >提交</n-button
                      >
                      <n-button
                        type="success"
        ...
        <n-card title="二级认证（实名认证）">
          <n-spin :show="data.realName" :rotate="false">
            ...
            >
              ...
              <n-button type="success" @click="handleRealName()">提交</n-button>
            </n-form>
          </n-spin>
        </n-card>
      </n-spin>
